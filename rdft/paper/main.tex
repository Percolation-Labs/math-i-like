...
\begin{figure}[H]
\centering
% BRW Corollas — thesis Figure 3.3 style (auto-generated by rdft)
...
\end{tikzpicture}
\caption{Corollas (amputated vertices) of the BRW, generated automatically
...
Using the general formula (thesis Eq.~2.99) with $n_e = 1$ for all edges:
\begin{equation}
...
and using Cheng--Wu ($\alpha_2 = 1$ normalisation):
\begin{align}
\mathcal{I}(G)
