...
The example script \texttt{crn\_survey.py} runs all 14 CRNs through the
full pipeline, producing the summary in Table~\ref{tab:crn_survey}.
All 12 systems with expected values pass validation; the remaining 2
(Lotka--Volterra and $2A \rightleftharpoons C$) are multi-species systems
whose effective single-variable DSE correctly produces square-root branches.
