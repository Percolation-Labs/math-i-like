...
\begin{abstract}
We apply CFAC \citep{Amarteifio2026cfac,
Amarteifio2026cfactheorem}---coupled Doi--Peliti /
Martin--Siggia--Rose renormalisation---to the chemotactic ant
colony and establish three things.  \emph{First}, a structural
recipe book: of five standard lattice ant models, only the
two-state switch $S\rightleftharpoons R$ satisfies all five CFAC
ingredients (I1)--(I5); each of the others violates a specific
ingredient for an identifiable reason.  \emph{Second}, the
...
\begin{equation}
  ...
  \text{(CFAC exact: }\tfrac{1}{2}\text{, error 0.00\%)}
  \;}
\end{equation}
