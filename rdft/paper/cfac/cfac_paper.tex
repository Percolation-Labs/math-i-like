...
\paragraph{A second coupled system, fully worked through.}
Everything in this paper has been demonstrated on KS; a second
coupled example---BARW with a field-driven branching rate, or a
predator--prey DP--MSR system, or a field-coupled Schl\"ogl---
would confirm that the machine runs generically.  We expect no
obstruction; this is the most obvious next step.
