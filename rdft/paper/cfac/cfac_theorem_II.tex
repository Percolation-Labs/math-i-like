...
\begin{enumerate}[label=(\roman*), leftmargin=1.8em, itemsep=2pt]
  ...
  \item \textbf{Multivariate non-smooth (cone and multiple) points.}
    Theorem~IIb is stated for smooth critical variety.
    Pemantle--Wilson's multivariate framework handles
    the multiple-point and cone-point cases; their asymptotics carry
    additional $O(\log m)^\kappa$ factors with $\kappa$ depending on
    the codimension of the crossing.  Extending Theorem~IIb to these
